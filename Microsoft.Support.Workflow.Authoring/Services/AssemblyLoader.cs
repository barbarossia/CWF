// -----------------------------------------------------------------------
// <copyright file="AssemblyLoader.cs" company="Microsoft">
...
namespace Microsoft.Support.Workflow.Authoring.Services
{
    ...
    /// <summary>
    /// Loads an assembly to check the inner activities and references of the assembly, essential for the import operation.
    /// </summary>
