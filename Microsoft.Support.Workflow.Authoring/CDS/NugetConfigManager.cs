...
namespace Microsoft.Support.Workflow.Authoring.CDS {
    public static class NugetConfigManager {
        ...
        private static List<CDSRepository> repositories;
        public static List<CDSRepository> Repositories {
            get {
        ...
        public static IEnumerable<CDSRepository> EnabledRepositories {
            get { return Repositories.Where(r => r.IsEnabled); }
        }
        ...
        private static List<CDSRepository> Load() {
