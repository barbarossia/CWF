...
namespace Microsoft.Support.Workflow.Authoring.CDS
{
    public static class QueryExtensions
    {
        ...
        public static MethodCallExpression GetSortExpression<T>(this IQueryable<T> source, IEnumerable<string> sortProperties, ListSortDirection direction, params Type[] knownTypes)
        {
