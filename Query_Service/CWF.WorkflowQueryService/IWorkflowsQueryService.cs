...
namespace CWF.WorkflowQueryService
{
    ...
    public interface IWorkflowsQueryService
    {
        ...
        /// <returns></returns>
        [OperationContract]
        WorkFlowTypeCreateOrUpdateReplyDC WorkflowTypeCreateOrUpdate(WorkFlowTypeCreateOrUpdateRequestDC request);
        ...
        [OperationContract]
        WorkflowTypeSearchReply SearchWorkflowTypes(WorkflowTypeSearchRequest request);
        ...
        /// <returns></returns>
        [OperationContract]
        AuthorizationGroupGetReplyDC GetAuthorizationGroups(AuthorizationGroupGetRequestDC request);

        [OperationContract]
        IList<TaskActivityDC> UploadActivityLibraryAndTaskActivities(StoreLibraryAndTaskActivityRequestDC request);

        [OperationContract]
        TaskActivityGetReplyDC SearchTaskActivities(TaskActivityGetRequestDC request);

        /// <summary>
        /// Get TaskActivity
        /// Get by Id or Guid Or ActivityId
        /// If Guid is not null,return the latest TaskActivity
        /// if Id is not null return the TaskActivity(Id = param)
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [OperationContract]
        TaskActivityDC TaskActivityGet(TaskActivityDC request);

        [OperationContract]
        TaskActivityDC TaskActivityUpdateStatus(TaskActivityDC request);
