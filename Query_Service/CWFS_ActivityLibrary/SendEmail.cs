...
{
    [IsToolBoxItem(true,ToolBoxDisplayName="Send Email",ToolBoxTabName=ToolTabNames.Business,ToolBoxToolTip="Allows user to send an email to somebody")]
    ...
    public class SendEmail : AsyncCodeActivity 
    {
        ...
        protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state) {
            ...
            SmtpClient smtp = new SmtpClient() {
                                                   Credentials = new NetworkCredential("blog@foo.com", ConfigurationManager.AppSettings["SMTPPassword"]),
                                                   Port = 587,
                                                   EnableSsl = true
                                               };
