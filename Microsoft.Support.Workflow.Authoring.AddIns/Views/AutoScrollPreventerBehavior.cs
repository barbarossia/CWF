...
namespace Microsoft.Support.Workflow.Authoring.Views
{
    ...
    /// <summary>
    /// Place this somewhere between a control and its ancestor ScrollViewer to prevent BringIntoView() from scrolling the ScrollViewer.
    /// We do this by swallowing the RequestBringIntoView routed event.
    /// </summary>
