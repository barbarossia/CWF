// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ActivityItem.cs" company="Microsoft Corporation">
...
namespace Microsoft.Support.Workflow.Authoring.AddIns.Models
{
    ...
    /// <summary>
    /// The activity item.
    /// This class is a wrapper for activity type.
    /// </summary>
    [Serializable]
    public class ActivityItem : ViewModelBase, IComparable<ActivityItem>
    {
        ...
        public static void GetActivityItemsFromAssembly(ActivityAssemblyItem activityAssemblyItem)
        {
            ...
            List<Type> activityTypes = Helper.GetAllActivityTypesInAssembly(assembly, activityAssemblyItem); // get activities and/or set NotSafeForTypeLoad
