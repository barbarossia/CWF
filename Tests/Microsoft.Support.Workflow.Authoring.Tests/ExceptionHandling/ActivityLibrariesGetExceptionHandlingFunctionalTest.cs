...
{
    [TestClass]
    public class ActivityLibrariesGetExceptionHandlingFunctionalTest
    {
        ...
        [WorkItem(205033)]
        [Description("Exception Handling: Verifies that the proper exception is thrown when a null request is issued")]
        [Owner("v-beriva")]
        [TestCategory("Func-NoDif1-Full")]
        [TestMethod()]
        public void ExceptionHandling_GetAllActivityLibraries_NullRequest()
        {
            try
            {
                WorkflowsQueryServiceUtility.UsingClient(client => client.GetAllActivityLibraries(null));
        ...
        [TestCategory("Func-NoDif1-Full")]
        [TestMethod()]
        public void ExceptionHandling_ActivityLibraryGet_NullRequest()
        {
            try
            {
                WorkflowsQueryServiceUtility.UsingClient(client => client.ActivityLibraryGet(null));
                Assert.Fail("Did not generate an Exception");
            }
            catch (FaultException<ValidationFault> ex)
            {
        ...
        [TestCategory("Func-NoDif1-Full")]
        [TestMethod()]
        public void ExceptionHandling_GetAllActivityLibraries_NullIncaller()
        {
            ...
            try
            {
                WorkflowsQueryServiceUtility.UsingClient(client => client.GetAllActivityLibraries(request));
                Assert.Fail("Did not generate an Exception");
            }
            catch (FaultException<ValidationFault> ex)
            {
        ...
        [TestCategory("Func-NoDif1-Full")]
        [TestMethod()]
        public void ExceptionHandling_ActivityLibrariesGet_NullInCaller()
        {
            ...
            try
            {
                WorkflowsQueryServiceUtility.UsingClient(client => client.ActivityLibraryGet(request));
                Assert.Fail("Did not generate an Exception");
            }
            catch (FaultException<ValidationFault> ex)
            {
        ...
        [TestCategory("Func-NoDif1-Full")]
        [TestMethod()]
        public void ExceptionHandling_ActivityLibrariesGet_NullInCallerVersion()
        {
        ...
        [TestCategory("Func-NoDif1-Full")]
        [TestMethod()]
        public void ExceptionHandling_GetAllActivityLibraries_NullInCallerVersion()
        {
            var request = new GetAllActivityLibrariesRequestDC
{
    Incaller = INCALLERNAME,
    IncallerVersion = null
        ...
        [TestCategory("Func-NoDif1-Full")]
        [TestMethod()]
        public void ExceptionHandling_GetAllActivityLibraries_EmptyIncaller()
        {
        ...
        [TestCategory("Func-NoDif1-Full")]
        [TestMethod()]
        public void ExceptionHandling_ActivityLibrariesGet_EmptyInCaller()
        {
        ...
        [WorkItem(205054)]
        [Description("Exception Handling: Verifies that the proper Validation Exception is thrown when a Empty IncallerVersion value is sent")]
        [Owner("v-beriva")]
        [TestCategory("Func-NoDif1-Full")]
        [TestMethod()]
        public void ExceptionHandling_ActivityLibrariesGet_EmptyInCallerVersion()
        {
        ...
        [TestCategory("Func-NoDif1-Full")]
        [TestMethod()]
        public void ExceptionHandling_GetAllActivityLibraries_EmptyInCallerVersion()
        {
            var request = new GetAllActivityLibrariesRequestDC
            {
                Incaller = INCALLERNAME,
        ...
        [WorkItem(205046)]
        [Description("Exception Handling: Verifies that the proper Validation Exception is thrown when a Very Large Incaller value is sent")]
        [Owner("v-beriva")]
        [TestCategory("Func-NoDif1-Full")]
        [TestMethod()]
        public void ExceptionHandling_GetAllActivityLibraries_VeryLargeIncaller()
        {
