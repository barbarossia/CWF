/****** Object:  StoredProcedure [dbo].[Activity_OverrideLock]    Script Date: 05/20/2013 23:53:42 ******/
SET ANSI_NULLS ON
GO
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Activity_OverrideLock]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Activity_OverrideLock]
GO
...
** *************************************************************************/
CREATE PROCEDURE [dbo].[Activity_OverrideLock]		
