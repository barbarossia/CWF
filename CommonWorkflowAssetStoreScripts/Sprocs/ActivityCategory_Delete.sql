...
/**************************************************************************
// Product:  CommonWF
// FileName: ActivityCategory_Delete.sql
// File description: Soft Deletes a row in the ltblActivityCategory table.
//
...
** *************************************************************************/
CREATE PROCEDURE [dbo].[ActivityCategory_Delete]
...
BEGIN TRY
    ...
    -- get the record from ActivityLibrary with the libraryname and version number
    -- but only if the ActivityLibrary.Status == 0
    SELECT  @Id = Id, 
