...
INSERT [dbo].[Environment] ([Id], [Name],[SoftDelete],[InsertedByUserAlias],[InsertedDateTime],[UpdatedByUserAlias],[UpdatedDateTime]) VALUES (3, N'stage', 0, 'setup', GETDATE(), 'setup', GETDATE())
INSERT [dbo].[Environment] ([Id], [Name],[SoftDelete],[InsertedByUserAlias],[InsertedDateTime],[UpdatedByUserAlias],[UpdatedDateTime]) VALUES (4, N'prod', 0, 'setup', GETDATE(), 'setup', GETDATE())
