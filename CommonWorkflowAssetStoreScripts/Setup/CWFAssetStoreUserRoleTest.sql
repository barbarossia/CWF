...
/****************************************************************************
** File: ArgusUserRoleTest.sql
**
** Desc: This script creates the [ArgusUserRoleTest] database role.
**
** Used Where/By:
...
SET @ModuleName         = N'ArgusUserRoleTest.sql'
...
/*
** Redmond\argtscv --- SECTION
*/


/*
** Add SQL Server login Redmond\argtscv windows account.
*/
...
BEGIN
   ...
   CREATE USER [argtscv] FOR LOGIN [Redmond\argtscv] WITH DEFAULT_SCHEMA = dbo
...
/*
** Add SQL Server login Redmond\BIIFTEST windows account.
*/

SET @DBUserName = 'BIIFTEST'
SET @DBLogin    = 'Redmond\BIIFTEST'
SET @DBSchema   = '[dbo]'
SET @DBRoleName = ''
SET @DBNAME     = DB_NAME()
...
/*
** Add the database userlogin Redmond\BIIFTEST service account.
*/
...
BEGIN
   ...
   CREATE USER [BIIFTEST] FOR LOGIN [Redmond\BIIFTEST]
